...
const LandingPage: React.FC<LandingPageProps> = ({ onEnter }) => {
  ...
  useEffect(() => {
    ...
    if (queryParam) {
      console.log('🔗 URL query parameter detected:', queryParam);
  ...
  return (
    <div className="landing">
      ...
      {/* Welcome Popup with GeoCopilot Icon */}
      {showWelcomePopup && (
        <div 
        ...
        >
          ...
          <div 
            ...
            style={{
              ...
              transform: isPopupVisible ? 'translateY(0) scale(1)' : 'translateY(20px) scale(0.95)',
          ...
          >
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.6, color: 'rgba(255, 255, 255, 0.9)' }}>
            ...
            <div 
              style={{
                ...
                borderTop: '8px solid rgba(30, 58, 95, 0.5)'
              }}
            />
          </div>

          {/* GeoCopilot Icon Button */}
          <div
