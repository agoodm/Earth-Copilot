...
const MapView: React.FC<MapViewProps> = ({ 
      ...
      if (onGeointAnalysis) {
        ...
        if (selectedModule === 'building_damage') {
          ...
          if (capturedScreenshot) {
            ...
            console.warn('⚠️ MapView: Failed to capture vision screenshot');
  ...
  useEffect(() => {
    ...
    try {
      ...
      const context = {
        bounds: bounds,
        imagery_base64: visionMode && visionScreenshot ? visionScreenshot : null, // Include screenshot when vision mode active
  ...
  }, [satelliteData, map, mapLoaded, mapProvider, onMapContextChange, lastCollection, visionMode, visionPin, visionScreenshot]);
