      ...
      <div className="health-tooltip">
        ...
        <div className="health-tooltip-content">
          <div className="health-section">
            ...
            <div className="health-status-item">
              <span className="health-label">AI Model ({healthData.connectivity_tests.azure_openai?.model || 'gpt-4o'}):</span>
              <span className={`health-value ${healthData.connectivity_tests.azure_openai?.status === 'connected' ? 'success' : 'error'}`}>
                {healthData.connectivity_tests.azure_openai?.status === 'connected' ? '✅ Connected' : '❌ Disconnected'}
              </span>
            </div>

            {healthData.connectivity_tests.azure_openai?.available_models && healthData.connectivity_tests.azure_openai.available_models.length > 0 && (
              <div className="health-status-item">
                <span className="health-label">Available Models:</span>
                <span className="health-value" style={{ color: '#8bb4e0' }}>
                  {healthData.connectivity_tests.azure_openai.available_models.join(', ')}
                </span>
              </div>
            )}
