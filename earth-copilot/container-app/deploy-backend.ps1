...
$azureOpenAiEndpoint = if ($currentEnv["AZURE_OPENAI_ENDPOINT"]) { $currentEnv["AZURE_OPENAI_ENDPOINT"] } else { "https://cog-foundry-m2grir76dsjlq.cognitiveservices.azure.com/" }
