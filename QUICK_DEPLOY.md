...
|--------|-------|-----------------|
| Source repo to fork | `microsoft/Earth-Copilot` | OSS (fixed) |
...
> 💡 Most Azure tenants have "Users can register applications" enabled by default, so you likely already have the Azure AD permission.
